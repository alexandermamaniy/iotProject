...
\begin{document}
	...
	{%\Large
		...
		\begin{center}
			...
			{\fontfamily{phv}\fontsize{12}{3}\selectfont{Area :   Internet of Things}}\\
			[0.5cm]
			{\fontfamily{phv}\fontsize{12}{3}\selectfont{Materia  :   Web, Robotica}}\\
			[3cm]

			
			{\fontfamily{phv}\fontsize{12}{3}\selectfont{Cochabamba, 2018}}\\[0.5cm]
		\end{center}
